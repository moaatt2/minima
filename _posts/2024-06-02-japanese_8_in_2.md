...
1. Start with 2 large rings stacked on each other as shown below.
    ...
    <canvas class="model_canvas" id="step_01"></canvas>
...
2. Pick a direction to expand in and place 2 more large rings(green in the image below) stacked on top of each other in that direction. When done, it should look something like this:
    ...
    <canvas class="model_canvas" id="step_02"></canvas>
...
3. Join the stacks of large rings from step 1 and step 2 using 2 small rings(green in the image below). When done, it should look something like this:
    ...
    <canvas class="model_canvas" id="step_03"></canvas>
...
4. Pick a direction to expand the weave and place stacks of 2 large rings(green in the image below) in front of each pair of large rings on that side of the weave. When done, it should look something like this:
    ...
    <canvas class="model_canvas" id="step_04"></canvas>
...
5. Join each pair of rings on the edge of the weave to the stacks of large rings placed in front of them in step 4 using 2 small rings(green in the image below). When done, it should look something like this:
    ...
    <canvas class="model_canvas" id="step_05"></canvas>
...
6. Join each pair of large rings from step 4 to the pair next to it using 2 small rings(green in the image below). When done, it should look something like this:
    ...
    <canvas class="model_canvas" id="step_06"></canvas>
...
<!-- Code for tutorial Models -->
{% include  3d_model.html model="/assets/models/japanese_8_in_2_step_01_v0_3.glb" canvas_id="step_01" ignore_canvas="Yes" is_secondary="Yes" %}
{% include  3d_model.html model="/assets/models/japanese_8_in_2_step_02_v0_3.glb" canvas_id="step_02" ignore_canvas="Yes" is_secondary="Yes" %}
{% include  3d_model.html model="/assets/models/japanese_8_in_2_step_03_v0_3.glb" canvas_id="step_03" ignore_canvas="Yes" is_secondary="Yes" %}
{% include  3d_model.html model="/assets/models/japanese_8_in_2_step_04_v0_2.glb" canvas_id="step_04" ignore_canvas="Yes" is_secondary="Yes" %}
{% include  3d_model.html model="/assets/models/japanese_8_in_2_step_05_v0_2.glb" canvas_id="step_05" ignore_canvas="Yes" is_secondary="Yes" %}
{% include  3d_model.html model="/assets/models/japanese_8_in_2_step_06_v0_2.glb" canvas_id="step_06" ignore_canvas="Yes" is_secondary="Yes" %}